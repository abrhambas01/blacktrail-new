<template>
	<div cl  ass="h-full w-full mt-6 h-screen overflow-hidden" style="background: #edf2f7;">
				...
				<div class="flex border border-grey rounded shadow-lg h-full">
					...
					<div class="w-1/3 border flex flex-col">
						...
						<div class="py-2 px-3 bg-grey-lighter flex flex-row justify-between items-center">
							<div>
								<img class="w-16 h-16 rounded-full" :src="currentUserAvatar"/>
							</div>
					...
					<div class="py-2 px-3 bg-grey-lighter flex flex-row justify-between items-center">
						<div class="flex items-center">
							<div>
								...
								<img class="w-12 h-12 rounded-full" :src="defaultAvatar"/>
							</div>
	...
	<div>
		<div class="h-32" style="background-color: #449388">
		</div>
		<div class="container mx-auto" style="margin-top: -128px;">
			<div class="py-6 h-screen">
				<div class="flex border border-grey rounded shadow-lg h-full">
					...
					<message-conversations :user="this.user" :messages="this.messages" :selectedContact="this.respondent">
					</message-conversations>		
				</div>
				...
				<div class="w-2/3 border flex flex-col">
					...
					<message-input :receiver="this.respondent" @saveMessage="saveMessage">
					</message-input>
...
export default {
	...
	data(){		
		return {
		   ...
		   methods : {
		   	async saveMessage(inputMessage, receiver = null){
	...
	// 	   			if ((!receiver && !inputMessage.trim().length)) {
	// 	   				return ;
	// 	   			}
...
computed : { 
	...
	currentUserAvatar(){	
		if(this.user.avatar === "default_avatar.jpg") {
			...
			return endpoints.urlDomain +"/storage/" +this.user.avatar ; 
		} 
	}
},
