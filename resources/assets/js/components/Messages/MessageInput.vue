<template>
  <div class="bg-grey-lighter px-4 py-4 flex items-center">
    ...
    <div class="flex-1 mx-4">
      <input v-model="inputMessage" @keypress.enter="sendMessage" placeholder="Type your message" class="w-full border rounded px-2 py-2" type="text"/>
    </div>
...
export default {
 props: ['activeChannel','username','chat'],
 data() {
  return {
    messageText: '',
    messages : []
