<template>
	<div>
		<div v-if="setupBilling" >
			<form class="bg-white m-auto h-full p-4" id="setup-billing-form" action="this.endpoint" method="POST">
...
export default {	
	...
	data () {
		return {
			setupBilling : false,
			endpoint : endpoints.convertCurrencyUrl
		}
	},
	mounted(){
		alert("You can only use paypal for this one.");
	}
};
</script>
