<user-filters inline-template>	
	<form @submit.prevent="searchCriminals">
		<div  class="bg-white mb-4 w-4/5 mt-4 px-4 py-4 rounded-sm">
			...
			<p class="font-bold text-md" v-show="criminalName && !criminal.sortBy && !criminal.country">or
			</p>
			...
			<div class="flex text-center" style="margin-top:3px;" v-show="criminalName && criminal.sortBy && criminal.country">
				<button @click="showSearchByName"  class="bg-blue p-2 h-10 mt-2 w-3/5 text-white hover:bg-black flex">
